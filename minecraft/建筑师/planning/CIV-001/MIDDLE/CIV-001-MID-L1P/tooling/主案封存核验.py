...
if a.freeze:
 ...
 result=dict(schema='primary-freeze/1',plan_revision='CIV-001-MID-L1P-r1',created_utc=datetime.now(timezone.utc).isoformat(),base_commit='903947cae6edf39ce088e4558c2dab12af705018',legacy_reads_this_run_before_freeze=False,prior_conversation_contains_legacy=True,world_writes=0,files=files)
