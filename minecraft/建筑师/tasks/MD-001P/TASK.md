...
> **整个中域应该如何在真实地形上形成一个可信的前现代接驳—商贸—加工—坡麓转换区域？**
...
8. `minecraft/建筑师/research/human-geography/southern-island/WB-002R-R1/`
9. `minecraft/建筑师/research/human-geography/southern-island/WB-003R/`
10. `minecraft/建筑师/research/build-sites/CIV-001/AB-001P1R/`
11. `minecraft/建筑师/research/human-geography/southern-island/territory-refinement/TT-002R/`
12. 本 Task Packet。
...
基于地理与中域 Canon，提出一套成熟期 settlement hierarchy。

至少考虑：

- **1 个 principal hub candidate**：中域最重要的接驳 / 商贸 / 加工 / 行政性聚落候选；
...
6. **Phasing / first-build recommendation map**
