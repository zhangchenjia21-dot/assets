...
const world = 'D:/Games/Minecraft/.minecraft/versions/26.2-Fabric 0.19.5/saves/苏州园林贰';
const manifest = JSON.parse(fs.readFileSync(manifestPath, 'utf8'));
if (manifest.world_path !== undefined && !world.endsWith('苏州园林贰')) throw new Error('路径保护');
